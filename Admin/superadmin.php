  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="superadmin.php"><i class="fa  fa-spinner"></i> <span>Registered students</span></a></li>
        
        <li><a href="#"><i class="fa  fa-minus-square"></i> <span>Student Denied</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-info">
     ...
     <div id="myModal" class="modal fade" role="dialog">
		...
		<?php
		  if (retrievestudents()>0)
		  {
                   foreach(retrievestudents() as $mystudents)
			   ...
			   ?>
                 ...
                 <tr>
                    ...
                    <td><?php echo $mystudents['admission'];?></td>
