  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="examcleared.php"><i class="fa  fa-check-square"></i> <span>Cleared</span></a></li>

        <li class="active"><a href=""><i class="fa  fa-spinner"></i> <span>Pending</span></a></li>
        
        <li><a href="examdenied.php"><i class="fa  fa-minus-square"></i> <span>Denied</span></a></li>
    ...
    <div class="box box-info">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin" style="margin-right:80px">
                  <thead>
                  <tr>
		...
		<?php
						...
						global $connection;
						$select="SELECT * FROM exam WHERE admission = $myadmission";
            ...
            <div class="form-group">
              ...
              <p><input type="text"  value="<?php echo $exam['cat'];?>" name="cat" required="" class="form-control" id="pwd"></p>
            </div>
            <div class="form-group">
              <label for="password">EXAM:</label>
              <p><input style="color:black;" value="<?php echo $exam['exam'];?>" name="exam" type="text" name="pwd" required="" class="form-control" id="pwd"></p>

            </div>
			
			<div class="form-group">
              <label for="password">PRATICAL:</label>
