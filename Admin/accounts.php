            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="logout.php" class="btn btn-default btn-flat">logout.php</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="accountscleared.php"><i class="fa  fa-check-square"></i> <span>Cleared</span></a></li>

        <li class="active"><a href=""><i class="fa  fa-spinner"></i> <span>Pending</span></a></li>
        
        <li><a href="accountsdenied.php"><i class="fa  fa-minus-square"></i> <span>Denied</span></a></li>
