    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- Optionally, you can add icons to the links -->
         <li class="active"><a href="studentscleared.php"><i class="fa  fa-check-square"></i> <span>Students Cleared</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="post" class="form">
		...
		<?php
		  if (projectcleared()>0)
		  {
                   foreach(projectcleared() as $cleared)
