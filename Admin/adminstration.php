  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="admincleared.php"><i class="fa  fa-check-square"></i> <span>Cleared</span></a></li>
...
<td><a href="<?php echo $myAdmissions['admission']?>" type="button" class="btn btn-danger" data-toggle="modal" data-target="#Modal<?php echo $myAdmissions['admission'];?>">progress</a></td>
        ...
        <div id="Modal<?php echo $myAdmissions['admission']?>" class="modal fade" role="dialog">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
              <label for="pwd">Losses:</label>
              <input type="text"  name="losses" required="" class="form-control" id="pwd">
            </div>
            <div class="form-group">
              <label for="password">Damages:</label>
              <input style="color:black;" name="damages" type="text" name="pwd" required="" class="form-control" id="pwd">
    ...
    //perform deny here
      ...
      $denyquery="UPDATE clear SET status = 3 WHERE admission = $admission AND departmentid = 4";
      $insertmessage = "INSERT INTO notifications(admission,message,status,date,departmentid)VALUES('$denyadmission',$message,1,NOW(),4)";
      $insertprogress ="INSERT INTO admin_progress(admission,fullname,losses,damages,messages)VALUES('$admission','$fullname','$losses','$damages','$message')";
      ...
      $damages = $_POST['damages'];
      $message= $_POST['message'];
      $clearquery="UPDATE clear SET status = 1 WHERE admission = $admission AND departmentid = 4";
      $insertmessage = "INSERT INTO notifications(admission,message,status,date,departmentid)VALUES('$admission','$message',1,NOW(),4)";
      $insertprogress ="INSERT INTO admin_progress(admission,fullname,losses,damages,messages)VALUES('$admission','$fullname','$losses','$damages','$message')";
    ...
    $progressresults =mysqli_query($connection,$insertprogress);
      if($clearresults)
      {
        ...
        ";
		  ...
		  {
			  echo "<tr><td>No record founds</tr></td>";
		  }
