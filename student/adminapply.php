...
function update()
{
	global $admission;
	global $connection;
	$update ="UPDATE clear SET status=2 WHERE admission=$admission and departmentid=4";
...
$selectQuery = "SELECT * FROM clear WHERE admission=$thevalue  and departmentid=4";
