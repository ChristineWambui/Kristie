            ...
            <div class="box-body">
              <div class="table-responsive">
                <?php
						...
						global $connection;
						$results=array();
						$selectprogress="SELECT*FROM admin_progress WHERE admission = '$MyAdmission'";
				...
				<p  class="form-control" id="email"><?php echo  $record['losses'];?></p>
				</div>
				
				<div class="form-group">
				<label for="pwd">Damages</label>
				<p class="form-control" id="email"><?php echo  $record['damages'];?></p>
				</div>
				
				<div class="form-group">
				<label for="pwd">Message</label>
			    <p class="form-control" id="email"><?php echo  $record['messages'];?></p>
				</div>
				</form>
				<?php
				  }
